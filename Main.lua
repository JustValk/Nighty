-- // Dependencies
local Aiming = loadstring(game:HttpGet("https://raw.githubusercontent.com/JustValk/Aiming/main/Examples/AimLock.lua"))()
...
local function ApplyPredictionFormula(SelectedPart)
    ...
    return SelectedPart.CFrame + (SelectedPart.(Vector3.new(Velocity.X, 0, Velocity.Z) * DaHoodSettings.Prediction)
end
