...
-- // Resolver part
TargetVelocity = Aiming.GetClosestPlayerToCursor.HumanoidRootPart.AssemblyLinearVelocity
Aiming.GetClosestPlayerToCursor.Character.HumanoidRootPart.AssemblyLinearVelocity = Vector3.new(TargetVelocity.X, -0.01, TargetVelocity.Y, TargetVelocity.Z)
-- //
